...
calificacionIMDBMayor = list(filter(lambda peliculas: float(peliculas["CalificaciónIMDB"]) >= 8.0, lista_peliculas))

calificacionMap = list(map(lambda pelicula: {"titulo": pelicula["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]}, calificacionIMDBMayor))


print(calificacionIMDBMayor)
print(calificacionMap)

import json
print(json.dumps(calificacionIMDBMayor, indent=2))
